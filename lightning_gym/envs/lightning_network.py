...
class NetworkEnvironment(Env):
    ...
    def get_illegal_actions(self): #tells agent to not look at neighbors as an action
    ...
    def generate_subgraph(self):
        ...
        while len(included_nodes) < self.k:
            ...
            unexplored_neighbors=unexplored_neighbors.union(neighbors-included_nodes) #Add cutoff = uexplored neighbors
